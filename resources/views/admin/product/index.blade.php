    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <div class="">
                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus"></i>&nbsp;اضافة منتج </button><br><br>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='5'>
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0"> الوصورة الرئسية</th>
                                <th class="border-bottom-0">الوصورة الفرعية</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-toggle="modal" data-target="#img_show{{$product->id}}"><img src="../uploads/{{$product->img1}}" width="40px" class="rounded-circle">
                                </td>
                                <td data-toggle="modal" data-target="#img_show{{$product->id}}"><img src="../uploads/{{$product->img2}}" width="40px" class="rounded-circle">
                                </td>
                                <td><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit{{$product->id}}" title="">
                                        <i class="fa fa-edit"></i></button></td>

                                <td>

                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete{{$product->id}}" title="">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{route('products.update',$product->id)}}" class="p-5 bg-white" method="POST" enctype="multipart/form-data">
                                                {{csrf_field()}}
                                                {{method_field('PUT')}}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="fishing_boot" value="{{$product->description}}" class="form-control" />
                                                    <input id="id" type="hidden" name="id" class="form-control" value="{{$product->id}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="img1" value="{{$product->img1}}" class="form-control" />
                                                    <input id="id" type="hidden" name="id" class="form-control" value="{{$product->id}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleFormControlTextarea1"> صورة الفرعية</label>
                                                    <input type="file" name="img2" value="{{$product->img2}}" class="form-control" />
                                                    <input id="id" type="hidden" name="id" class="form-control" value="{{$product->id}}">
                                                </div>
                                        </div>
                            ...
                            <!--  img- show -->
                            <div class="modal fade" id="img_show{{$product->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <center><img src="../uploads/{{$product->image}}" width="400px" class="rounded-circle"></center>
